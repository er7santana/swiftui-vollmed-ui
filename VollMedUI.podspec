...
Pod::Spec.new do |s|
  s.name             = 'VollMedUI'
  s.version          = '0.1.0'
  s.summary          = 'A short description of VollMedUI.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/er7santana/VollMedUI'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'er7santana' => 'er.7santana@gmail.com' }
  s.source           = { :git => 'https://github.com/er7santana/VollMedUI.git', :tag => s.version.to_s }
